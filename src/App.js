  ...
  return (
    <div className="App bg-liteBlack h-max">
      <div className='flex flex-col'>
        ...
        <h1 className='md:text-7xl text-5xl flex justify-center pt-10 font-poppins text-white font-semibold'>Ani<p className='text-liteOrange'>`</p>Q</h1>
        ...
        <div className='md:w-80 w-64 h-1 bg-liteOrange mx-auto opacity-70 m-2 rounded-lg'></div>
          <form className='flex justify-center pt-5 text-white items-center font-poppins' onSubmit={(e) => handleSubmit(e)}>
            ...
            <button onClick={() => {refetch(); setIsHome(false)}} className=" absolute md:ml-80 sm:ml-44 ml-24 border-2 rounded-3xl px-4 py-2 border-liteOrange bg-liteOrange hover:bg-orange-700 transition duration-200 text-xl" type='submit'>Go</button>
